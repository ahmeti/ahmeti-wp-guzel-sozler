...
<div id="ahmeti_wrap" style="padding:10px">
    ...
    <div style="overflow: hidden">
        <div style="float: left">
            <h1 style="font:oblique 30px/30px Georgia,serif; color:grey;background-image: url('<?php echo plugins_url(); ?>/ahmeti-wp-guzel-sozler/images/icon.png');background-repeat: no-repeat;padding: 20px 10px 10px 37px;background-position: 0 0;">Ahmeti WP Güzel Sözler <sup style="font-size: 12px">3.0</sup></h1>            
        </div>
