    ...
    <table style="width: 700px">
        ...
        <tr>
            ...
            <td style="padding: 5px;border: 1px solid #ddd;">
                <a href="<?php echo PHP_D_URL; ?>&islem=author_guncelle&id=<?php echo $soz->wp_soz_author_id; ?>"><img src="<?php echo plugins_url().'/ahmeti-wp-guzel-sozler/images/add.png'; ?>" /></a>
                <a href="<?php echo PHP_D_URL; ?>&islem=delete_author&id=<?php echo $soz->wp_soz_author_id; ?>"><img src="<?php echo plugins_url().'/ahmeti-wp-guzel-sozler/images/cancel.png'; ?>" /></a>
            </td>
        </tr>
        <?php
        }
